...
| M | REQ | AC | 요약 | 상태 |
|---|---|---|---|---|
| M1 | — (D-1) | — | **설계 확정 — `AIAssistant` 기법 A/B 선택.** 착수 승인 게이트에서 운영자가 골랐다 — **2026-09-22 B안 채택.** 고른 안이 M3의 내용과 M4의 렌즈 명단(`ui-design` 포함)을 함께 정했다 | ✅ 2026-09-22 — B안 |
...
**[해소 2026-09-22 — 운영자 확정: B안(확정 시점 이름 구분) 채택. 리드 디스패치로 run 레인에 전달됐고 progress.md §E.1에 기록했다. 이 결정이 M3의 내용과 M4 렌즈 명단(`ui-design` 포함)을 함께 확정했다]**
