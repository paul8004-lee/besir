...
| T-004 | 어포던스 11절 대조·범위 diff 검사·양쪽 무경고 빌드·드라이버(단언 추가 금지)·프록시·검토 2인(ui-design·code-safety) | REQ-030, REQ-031, REQ-040, REQ-041 | T-001, T-002, T-003 | (문서) .moai/specs/SPEC-UIKIT-004/* | done |
